...
const navigationGroups = [
  { title: "Tinjauan Eksekutif", items: [{ name: "Dasbor Utama", path: "/admin", icon: Icons.Dashboard }] },
  { title: "Manajemen Inventaris", items: [{ name: "Kategori Komoditas", path: "/admin/kategori", icon: Icons.Category }, { name: "Katalog Master", path: "/admin/produk", icon: Icons.Product }] },
  { title: "Operasional", items: [{ name: "Pusat Logistik", path: "/admin/pesanan", icon: Icons.Order }, { name: "Buku Besar (Invoice)", path: "/admin/transaksi", icon: Icons.Invoice }] },
  { title: "Kepatuhan & Keamanan", items: [{ name: "Verifikasi KYC", path: "/admin/kyc", icon: Icons.KYC }, { name: "Log Audit Sistem", path: "/admin/audit", icon: Icons.Audit }] }
];
