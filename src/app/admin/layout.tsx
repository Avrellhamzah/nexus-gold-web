              ...
              {isProfileOpen && (
                <>
                  ...
                  <div className="absolute right-0 mt-4 w-52 bg-[#161B18] border border-[#2E3730] rounded-lg shadow-2xl z-50 py-1.5 transform origin-top-right animate-in fade-in zoom-in-95 duration-200">
                    ...
                    <Link href="/admin/pengaturan" onClick={() => setIsProfileOpen(false)} className="px-4 py-2.5 text-[11px] font-bold text-zinc-400 hover:text-zinc-200 hover:bg-[#1C221E] transition-colors flex items-center gap-2">
